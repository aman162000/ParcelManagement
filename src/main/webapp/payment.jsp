...
<body>
            ...
            <div class="bill-summary">
                ...
                <div class="bill-details">
                    ...
                    <div class="bill-item total">
                        ...
                        <span id="totalBillAmount">₹0</span>
                    </div>
                </div>
            </div>
            ...
            <div class="payment-form">
                ...
                <form id="paymentForm">
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <label class="radio-label">
                                <input type="radio" name="paymentMode" value="credit" required>
                                Credit Card
                            </label>
                            <label class="radio-label">
                                <input type="radio" name="paymentMode" value="debit" required>
                                Debit Card
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="button-group">
                        <button type="submit" class="btn btn-primary" id="payNowBtn" disabled>
                            💳 Pay Now
                        </button>
                        <button type="button" class="btn btn-secondary" onclick="backToBooking()">
                            ← Back to Booking
                        </button>
                    </div>
                </form>
    ...
    <div id="paymentSuccessModal" class="modal hidden">
        <div class="modal-content">
            ...
            <div class="success-details">
                ...
                <p><strong>Payment Time:</strong> <span id="successTime"></span></p>
                <p class="success-message">Your parcel will be picked up as scheduled.</p>
            </div>
            <div class="button-group">
                <button onclick="viewInvoice()" class="btn btn-primary">View Invoice</button>
