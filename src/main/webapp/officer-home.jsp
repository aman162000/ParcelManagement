...
<body>
    <nav class="navbar">
        ...
        <ul class="nav-menu">
            <li><a href="officer-home.html" class="active">Home</a></li>
            <li><a href="tracking.html">Tracking</a></li>
            <li><a href="delivery-status.html">Delivery Status</a></li>
            <li><a href="pickup-scheduling.html">Pickup Scheduling</a></li>
            <li><a href="booking-history.html">Previous Booking</a></li>
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-grid">
            <div class="dashboard-card">
                ...
                <a href="booking.html" class="btn btn-primary">Create Booking</a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <a href="tracking.html" class="btn btn-primary">View Packages</a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <a href="pickup-scheduling.html" class="btn btn-primary">Schedule Pickup</a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <a href="booking-history.html" class="btn btn-primary">View Records</a>
            </div>
        </div>
